class Todo {
  ...
  stateClasses = {
    isVisible: 'is-visible', isDisappearing: 'is-disappearing',
  }
  ...
  filter() {
    ...
    this.state.filteredItem = this.state.items.filter(({title}) => {
  ...
  onDeleteAllButtonClick = () => {
    const isConfirmed = confirm('Are you sure you wanna delete all?')
